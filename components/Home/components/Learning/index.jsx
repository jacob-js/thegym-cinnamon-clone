...
function Learning() {
  return (
    <div className='bg-white relative overflow-hidden'>
        ...
        <img src="https://cinnamon.agency/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcinn-college-illustration.180f68e4.png&w=640&q=75" alt="" className="hidden lg:block absolute -bottom-2 right-0 max-w-[556px] max-h-[402px]" />
    </div>
  )
}
