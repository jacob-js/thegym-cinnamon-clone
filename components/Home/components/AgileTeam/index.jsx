  ...
  return (
    <div className='bg-lighter relative overflow-hidden'>
        <div className="content py-40 gap-8 grid lg:grid-cols-12 relative z-20">
            ...
            <img src="https://cinnamon.agency/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fagile-team-on-demand.316271d9.png&w=384&q=75" alt="" className="block lg:hidden max-w-[338px] max-h-[220px] z-10" />
        ...
        <img src="https://cinnamon.agency/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fagile-team-on-demand.316271d9.png&w=384&q=75" alt="" className="hidden lg:block absolute -bottom-2 right-0 max-w-[338px] max-h-[220px] z-10" />
    </div>
  )
}
